...
export type Incident = { job_id: string; job: string; incident: { change: { kind: string; target: string; protocol?: string; port?: number; old?: string; new?: string; severity: string }; opened_at: string; last_seen_at: string } }
